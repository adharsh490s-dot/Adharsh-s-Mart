...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SwiftCart is a premium online marketplace with millions of products, daily deals and fast delivery." },
      { name: "author", content: "SwiftCart" },
