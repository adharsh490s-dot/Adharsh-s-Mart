...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Adharsh's Mart is a premium online marketplace with millions of products, daily deals and fast delivery." },
      { name: "author", content: "Adharsh's Mart" },
